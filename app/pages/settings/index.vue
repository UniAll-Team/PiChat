...
en:
  ...
  profile:
    ...
    full_name:
      label: Full Name
      description: Will appear on receipts, invoices, and other
        communication.
    email:
      label: Email
      description: Used to sign in, for email receipts and product
        updates.
    bio:
      label: Bio
      description: Brief description for your profile. URLs are
        hyperlinked.
    password:
      label: Password
      description: Confirm your current password before setting
        a new one.
      new: New password
  ...
  account:
    title: Account
    description: No longer want to use our service? You can delete
      your account here. This action is not reversible. All information
...
de:
  ...
  theme:
    title: Thema
    description: Passen Sie das Aussehen und die Gestaltung Ihres
      Dashboards an.
  profile:
    title: Profil
    description: Verwalten Sie Ihre grundlegenden Profilinformationen.
    save: Änderungen speichern
    full_name:
      label: Vollständiger Name
      description: Wird auf Quittungen, Rechnungen und anderen
        Mitteilungen angezeigt.
    email:
      label: E-Mail
      description: Wird zum Anmelden, für E-Mail-Quittungen und
        Produktaktualisierungen verwendet.
    bio:
      label: Biografie
      description: Kurze Beschreibung für Ihr Profil. URLs werden
        automatisch verlinkt.
    password:
      label: Passwort
      description: Bestätigen Sie Ihr aktuelles Passwort, bevor
        Sie ein neues festlegen.
      new: Neues Passwort
      repeat: Neues Passwort wiederholen
      mismatch: Passwörter müssen übereinstimmen
  account:
    title: Konto
    description: Möchten Sie unseren Service nicht mehr nutzen?
      Hier können Sie Ihr Konto löschen. Diese Aktion ist nicht
      umkehrbar. Alle Informationen zu diesem Konto werden dauerhaft
      gelöscht.
...
ar:
  ...
  profile:
    ...
    email:
      ...
      description: يستخدم لتسجيل الدخول وإيصالات البريد الإلكتروني
        وتحديثات المنتج.
    bio:
      label: النبذة التعريفية
      description: وصف موجز لملفك الشخصي. سيتم ربط عناوين URL
        تلقائياً.
    password:
      label: كلمة المرور
      description: قم بتأكيد كلمة المرور الحالية قبل تعيين كلمة
        مرور جديدة.
  ...
  account:
    title: الحساب
    description: لم تعد ترغب في استخدام خدمتنا؟ يمكنك حذف حسابك
      هنا. هذا الإجراء لا رجعة فيه. سيتم حذف جميع المعلومات المتعلقة
      بهذا الحساب بشكل دائم.
    delete: حذف الحساب
  toast:
